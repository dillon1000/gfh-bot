...
CMD ["sh", "-c", "pnpm prisma migrate deploy && node --experimental-loader=@opentelemetry/instrumentation/hook.mjs --import ./dist/src/app/instrumentation.js dist/src/app/index.js"]
