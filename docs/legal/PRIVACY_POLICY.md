...
- Corpse game entries and AI-generated opening lines
- Dilemma and mural participation data
...
- Dilemma, corpse, mural, and quips participation records and scores
...
- From service providers used to operate the App, such as hosting, database, cache, storage, logging, and AI providers
...
- Send content to configured AI providers when AI features are enabled
...
Certain optional features may send limited content to third-party AI providers to generate creative outputs.

At the time of this draft, the App may use:

- xAI for features such as AI-generated corpse openers or quips prompts
- Google AI Studio / Gemini for quips prompt generation

If these features are enabled, prompts, recent prompt examples, moderation settings like adult mode, and related generation context may be transmitted to the configured provider. Do not enable or use AI features for highly sensitive information unless you have separately reviewed the provider's terms and data practices and determined that use is appropriate for your server.

## 8. Exports and Public Sharing
...
- **AI providers**, including xAI and Google, if AI features are enabled
...
The App may rely on or link to third-party services, including Discord, Cloudflare, xAI, Google, and hosting providers. Their privacy practices are governed by their own policies, not this Privacy Policy.
